 ...
 * @list: Pointer to head of a doubly-linked list pf integers.
...
/**
 * swap_node_behind - Swap a node in a lintint_t doubly-linked list
 * 		      of integers with the node behind it.
 * @list: Pointer to head of doublt-linked lidt of integers
 * @tail: Pointer to tail of the doubly-llinked list.
 * @shaker: Pointer to current swapping node of the cocktail shaker algo.
 */
 ...
 * 			in ascending order using the cocktail shaker algo
 * @list: Pointer to head of listiint_t doubly-linked list.
 */
